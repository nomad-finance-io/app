...
export function getObservationEncoder(): FixedSizeEncoder<ObservationArgs> {
    return getStructEncoder([['blockTimestamp', getU64Encoder()], ['cumulativeToken0PriceX32', getU128Encoder()], ['cumulativeToken1PriceX32', getU128Encoder()]]);
}

export function getObservationDecoder(): FixedSizeDecoder<Observation> {
    return getStructDecoder([['blockTimestamp', getU64Decoder()], ['cumulativeToken0PriceX32', getU128Decoder()], ['cumulativeToken1PriceX32', getU128Decoder()]]);
}
