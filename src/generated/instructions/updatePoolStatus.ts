...
export const UPDATE_POOL_STATUS_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([130, 87, 108, 6, 46, 224, 117, 123]);

export function getUpdatePoolStatusDiscriminatorBytes(): ReadonlyUint8Array { return fixEncoderSize(getBytesEncoder(), 8).encode(UPDATE_POOL_STATUS_DISCRIMINATOR); }
...
export function getUpdatePoolStatusInstruction<TAccountAuthority extends string, TAccountPoolState extends string, TProgramAddress extends Address = typeof NOMAD_AMM_PROGRAM_ADDRESS>(input: UpdatePoolStatusInput<TAccountAuthority, TAccountPoolState>, config?: { programAddress?: TProgramAddress } ): UpdatePoolStatusInstruction<TProgramAddress, TAccountAuthority, TAccountPoolState> {
  // Program address.
...
export type ParsedUpdatePoolStatusInstruction<TProgram extends string = typeof NOMAD_AMM_PROGRAM_ADDRESS, TAccountMetas extends readonly AccountMeta[] = readonly AccountMeta[]> = { programAddress: Address<TProgram>;
accounts: {
